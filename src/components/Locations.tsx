...
const Locations: React.FC<LocationsProps> = ({ isDarkMode }) => {
  ...
  // Use locations from brand config
          ...
          {locations.map((location, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full mt-6 bg-amber-600 hover:bg-amber-700 text-white py-3 rounded-xl font-medium transition-colors duration-300">
                  {t('locations.viewMap')}
                </button>
              </div>
            </div>
